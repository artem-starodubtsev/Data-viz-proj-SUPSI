    ...
    return (
        <div ref={containerRef} className="snap-container">
            ...
            <Slide className="bg-gradient-to-br from-[hsl(145,50%,25%)] to-[hsl(180,40%,20%)]">
                ...
                <div
                    className="absolute inset-0 bg-gradient-to-t from-[hsl(220,20%,10%)/80] via-transparent to-transparent"/>
          ...
          <span
            ...
            <Slide className="bg-background">
                ...
                <div
                    className="relative z-10 container max-w-screen-2xl px-6 h-full min-h-0 flex flex-col justify-center py-[clamp(2rem,6vh,4rem)]">
                    <div className="text-center mb-[clamp(1.5rem,4vh,2.5rem)] animate-slide-up">
                        ...
                        <p className="font-body text-xl md:text-2xl leading-relaxed text-foreground max-w-4xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-3 gap-8 animate-slide-up delay-200">
                        ...
                        >
                            <div
                                className="w-16 h-16 rounded-full bg-accent/10 flex items-center justify-center mx-auto mb-5">
            ...
            <Slide className="bg-secondary/30">
                ...
                <div className="relative z-10 container max-w-screen-2xl px-6 h-full min-h-0 flex flex-col py-6">
                    <div className="text-center mb-4">
                        ...
                        <p className="font-body text-lg md:text-xl text-foreground max-w-4xl mx-auto animate-slide-up delay-100">
                    ...
                    <div className="flex-1 min-h-0 flex flex-col lg:flex-row lg:items-start gap-6">
                        <div
                            className="flex-1 min-h-0 lg:self-stretch bg-card/95 backdrop-blur-sm rounded-2xl border border-border shadow-elevated p-4 lg:p-8 animate-fade-in-scale delay-200 flex flex-col">
                            <div
                                className="relative flex-1 min-h-0 bg-muted/30 rounded-lg overflow-hidden aspect-[4/3] lg:aspect-[16/9] max-h-full">
                                <iframe
                        ...
                        <div className="w-full lg:w-96 shrink-0 animate-slide-up delay-150 lg:self-start">
                            <div className="bg-card/95 backdrop-blur-sm rounded-2xl p-4 lg:p-8">
                                ...
                                <div className="mt-4 space-y-4">
                                    {[
                                        ...
                                        {title: "Outliers", desc: "Switzerland (low BMI) vs USA (high BMI)"},
                                        {
                                            ...
                                            desc: "Geography shapes BMI bands at similar incomes"
                                        },
                                    ].map((item, i) => (
                            ...
                            >
                                <div className="flex items-center gap-4 mb-4">
                                    <div className="w-1 h-12 rounded-full"
                                         style={{backgroundColor: regionData[activeRegion].color}}/>
                                    <div>
                    <span
                    ...
                    >
                      {regionData[activeRegion].subtitle}
                                ...
                                <div className="space-y-3">
                                    {regionData[activeRegion].content.map((paragraph, index) => (
                                        <div key={index} className="flex gap-3">
                                            <span
                                                className="mt-2 w-1.5 h-1.5 rounded-full bg-muted-foreground/40 shrink-0"/>
                        ...
                        <div className="order-2 lg:order-1 flex-1 min-h-0">
                            <div
                                className="h-full bg-card/95 backdrop-blur-sm rounded-2xl border border-border shadow-elevated p-4 lg:p-8 animate-fade-in-scale delay-200 flex flex-col min-h-0">
            ...
            <Slide className="bg-secondary/30">
                ...
                <div className="relative z-10 container max-w-screen-2xl px-6 h-full flex flex-col py-6">
                    ...
                    <div className="flex-1 flex gap-6 min-h-0 items-start">
                        <div
                            className="flex-1 self-stretch bg-card/95 backdrop-blur-sm rounded-2xl border border-border shadow-elevated p-4 lg:p-8 animate-slide-in-left flex flex-col">
                            <div
                                className="relative flex-1 bg-muted/30 rounded-lg overflow-hidden aspect-[4/3] lg:aspect-square max-h-full">
                                <iframe
                        ...
                        <div className="w-96 shrink-0 animate-slide-up delay-100 self-start">
                            <div
                                className="bg-card/95 backdrop-blur-sm rounded-2xl border border-border shadow-elevated p-6 lg:p-8">
                                <p className="font-body text-base leading-relaxed text-muted-foreground">
                                    Across every region, obesity rises steadily. The important feature is how{" "}
                                    <span className="font-medium text-foreground">"smooth"</span> the lines are: no
                                    dramatic
                                ...
                                <div className="mt-4 p-4 rounded-xl bg-accent/10 border border-accent/20">
                                    <div className="flex gap-3">
                                        ...
                                        <p className="font-body text-sm text-muted-foreground">
                                            Even regions with affordable healthy diets continue to climb, showing that
                                            wealth
            ...
            <Slide className="bg-background">
                ...
                <div
                    className="relative z-10 container max-w-screen-2xl px-6 h-full min-h-0 flex flex-col justify-center py-[clamp(1.5rem,4vh,3rem)]">
                    <div className="grid lg:grid-cols-2 gap-10 items-center">
                        <div className="space-y-6 lg:space-y-8 animate-slide-up">
                            ...
                            <div
                                className="p-6 lg:p-10 rounded-2xl bg-gradient-to-br from-primary/15 via-primary/5 to-accent/15 border border-primary/20">
                        ...
                        <div className="space-y-4 animate-slide-up delay-200">
                            <div
                                className="bg-card/90 backdrop-blur-sm rounded-xl border border-border shadow-soft p-6 lg:p-8">
                            ...
                            <div
                                ...
                                <div className="flex gap-4">
                                    ...
                                    <p className="font-body text-lg leading-relaxed text-muted-foreground">
                                        ...
                                        income. Other regions have generally affordable healthy diets, yet still
                                        struggle
